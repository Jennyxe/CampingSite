...
<section class="header" id="home">
	...
	<div class="s-container">
		...
		<h1>Discover The <span>Beautiful Camp Sites</span></h1>
	</div>
	...
	if ($num_rows == 0) echo "<p>There is no pitch site!</p><br>";
	...
	for ($i = 0; $i < $num_rows; $i++) {
		...
		echo "<br>";
		echo "<img src='" . $record['photo'] . "' width='500' height='300'><br>";
		...
		if ($urname == "admin") {
			...
			echo "<button><a href='booking_list.php'>Booklists</a></button>";
			echo "<button><a href='contact_list.php'>Contactlists</a></button>";
		}
			...
			echo "<button><a href='review_list.php?id=".$record['id']."'>Review</a></button>";
			echo "<button><a href='features_list.php?id=".$record['id']."'>Feature & LA</a></button>";
			echo "<button><a href='book.php.?id=" . $record['id'] . "'>Book Now</a></button>";
