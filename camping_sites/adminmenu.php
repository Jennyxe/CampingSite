...
<body>
    <div class="banner">
        <video src="./Images/campfire2.mp4" type="video/mp4" autoplay muted loop></video>
        ...
        <section class="header" id="home">
            ...
            <div class="text-box">
                <h1>Start To Explore Find the best campsites</h1>
                ...
                <a href="book.php" class="hero">Book Now!</a>
            </div>
    ...
    <section class="location">
        ...
        <div class="location-content">
            ...
            <div class="col-content">
                <a href="camping_list.php"><img src="./Images/uk1.jpg" alt=""></a>
                <h5>Scotland</h5>
                <p></p>
            </div>
            ...
            <div class="col-content">
                <a href="camping_list.php"><img src="./Images/us.jpg" alt=""></a>
                <h5>England</h5>

            </div>

            <div class="col-content">
                <a href="camping_list.php"><img src="./Images/uk.jpg" alt=""></a>
                <h5>USA</h5>

            </div>

            <div class="col-content">
                <a href="camping_list.php"><img src="./Images/us1.jpg" alt=""></a>
                <h5>Italy</h5>
                <p></p>
            </div>
    </section>
    ...
    <div class="google-map">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5894.71094214454!2d-81.40629470772632!3d28.539235888800647!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88e77bb4b4421213%3A0x28fd8f95e049f5de!2sCamping%20World%20Stadium!5e0!3m2!1smy!2smm!4v1685583823495!5m2!1smy!2smm" width="800" height="300" style="border: 3px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
